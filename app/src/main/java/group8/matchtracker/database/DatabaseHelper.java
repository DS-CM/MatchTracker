...
/*    private static class MatchTrackerOpenHelper extends SQLiteOpenHelper{
        ...
        @Override
        public void onCreate(SQLiteDatabase db){
            db.execSQL("CREATE TABLE "+TABLE_EVENT+"("+EVENT_ID+" INTEGER PRIMARY KEY, "+EVENT_NAME+" TEXT, "+EVENT_START+" LONG, "+EVENT_END+" LONG, "+EVENT_LOCATION+" TEXT, "+EVENT_ORGANIZER+" TEXT)");
            db.execSQL("CREATE TABLE "+TABLE_TOURNAMENT+"(eid INTEGER PRIMARY KEY, name TEXT)");
